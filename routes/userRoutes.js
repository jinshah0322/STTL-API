...
const {getAllUsers,loginUser,registerUser,profile,forgotPassword, changePassword, deleteaccount, editProfile,blockUser,unblockUser,contactUs} = require("../Controller/userController")
